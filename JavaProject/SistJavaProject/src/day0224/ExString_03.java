...
public class ExString_03 {
	...
	public static void main(String[] args) {
		...
		//indexof : ( )안에 문자를 입력하면 문자열에서 해당 문자가 몇번째에 위치해 있는지 확인(0부터 시작, 공백도 포함)
		...
		//a.compareTo(b) : 알파벳의 차이만큼 (아스키코드 값 차이만큼) 결과값 출력
		//a와 b가 같을경우 0
		...
		//replace메서드 : 문자열의 일부를 변경
		System.out.println(str3.replace('a', '*')); //결과 : H*ve * Nice D*y!!!
		System.out.println(str3.replace("Nice", "Good")); //결과 : Have a Good Day!!!
		
		//valueof : int==>String(int를 String으로 형변환)
